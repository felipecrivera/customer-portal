...
function Header() {
  ...
  return pathname.startsWith("/signin") || pathname.startsWith("/signup") ? (
    ...
    <header className="relative w-full py-4 lg:h-full lg:w-72 lg:py-8">
      ...
      <div
        className="relative z-10 flex h-full justify-between gap-10 px-5 lg:flex-col"
        style={{ height: "90vh" }}
      >
        ...
        <ul className="hidden flex-1 space-y-1.5 lg:block">
          {localStorage.getItem("isUserLoggedIn") == "true" &&
            (customer.dashboardDisplay === "Both" ? (
              <>
                <li>
                  <a
              ...
              <li>
                <a
                  className={`group flex items-center gap-3.5 rounded-lg px-2.5 py-2 font-medium text-white transition hover:bg-secondary hover:text-white`}
                  href={
                    customer.dashboardDisplay == "Booking"
                      ? "/bookings"
                      : "/activations"
                  }
                >
                  ...
                  <span>{customer.dashboardDisplay}</span>
                </a>
              </li>
            ))}
          <li>
